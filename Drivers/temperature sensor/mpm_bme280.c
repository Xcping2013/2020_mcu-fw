...
{
	SoftI2c.reads(bme280_iic,1,0xEE,reg_addr,data,len);
	return 0;
}

int8_t user_i2c_write(uint8_t id, uint8_t reg_addr, uint8_t *data, uint16_t len)
{
	SoftI2c.writes(bme280_iic,1,0xEE,reg_addr,data,len);
  return 0;
}
...
MSH_CMD_EXPORT_ALIAS(print_bme280, TEMP,...);
