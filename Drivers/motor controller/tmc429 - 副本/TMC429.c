...
void Init429(UCHAR Which429 )
{
  ...
  Write429Int(Which429, IDX_IF_CONFIG_429, IFCONF_EN_SD|IFCONF_EN_REFR|IFCONF_SDO_INT);
  Write429Datagram(Which429, IDX_SMGP, 0x00, 0x00, 0x02);

	if(Which429==SPI_DEV0_TMC429)
	{
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR0, 0x00, (MotorConfig[0].PulseDiv<<4)|(MotorConfig[0].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR1, 0x00, (MotorConfig[1].PulseDiv<<4)|(MotorConfig[1].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR2, 0x00, (MotorConfig[2].PulseDiv<<4)|(MotorConfig[2].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR0, 0x00, NO_REF, 0x00);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR1, 0x00, NO_REF, 0x00);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR2, 0x00, NO_REF, 0x00);
	}
	else if(Which429==SPI_DEV1_TMC429)
	{
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR0, 0x00, (MotorConfig[3].PulseDiv<<4)|(MotorConfig[3].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR1, 0x00, (MotorConfig[4].PulseDiv<<4)|(MotorConfig[4].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_PULSEDIV_RAMPDIV|MOTOR2, 0x00, (MotorConfig[5].PulseDiv<<4)|(MotorConfig[5].RampDiv & 0x0f), 0x06);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR0, 0x00, NO_REF, 0x00);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR1, 0x00, NO_REF, 0x00);
		Write429Datagram(Which429, IDX_REFCONF_RM|MOTOR2, 0x00, NO_REF, 0x00);
	}
