...
{
	{
		.pin.scl_pin=PC_10,////DEV2 	PD_6,//DEV0
		.pin.sda_pin=PC_11,//PD_7,							//
		.int_pin=PA_15,//PD_5,									//
	...
	{
		.pin.scl_pin=PC_12,//DEV3						PD_13,//DEV1
		.pin.sda_pin=PD_2,//PD_12,							//
		.int_pin=PE_3,//PD_14,									//
...
void lightSensor(int argc, char **argv)
{
    ...
    if (argc == 1 && rgb_installed!=0)
    {
		...
		else if (argc == 3&& rgb_installed!=0)
		{
			...
			{
				isl29125_range_t rang_temp=ISL29125_RANGE_375;
			...
			{
				isl29125_resolution_t res_temp=ISL29125_RESOLUTION_16;
				if(!strcmp(argv[2], "12bit"))	res_temp=ISL29125_RESOLUTION_12;
				if(!strcmp(argv[2], "16bit"))	res_temp=ISL29125_RESOLUTION_16;
				dev[0].res=res_temp;			dev[1].res=res_temp;
				isl29125_init(&dev[0]);isl29125_init(&dev[1]);
			}		
